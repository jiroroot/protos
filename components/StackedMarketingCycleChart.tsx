...
export function StackedMarketingCycleChart() {
        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="text-sm text-gray-500">
                Impressions {marketingCycleData[marketingCycleData.length - 1]?.reach?.toLocaleString()} ↑ 12%
              </div>
            </div>
            <div className="h-[80px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart 
                  data={marketingCycleData}
                ...
                >
                  ...
                  {hoveredIndex !== null && (
                    <ReferenceLine 
                      x={marketingCycleData[hoveredIndex]?.date} 
                      stroke="#3b82f6" 
                      strokeDasharray="3 3"
                      strokeWidth={1}
                    />
          ...
          <div className="relative">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="text-sm text-gray-500">
                Interactions {marketingCycleData[marketingCycleData.length - 1]?.inform?.toLocaleString()} ↓ 3.2%
              </div>
            </div>
            <div className="h-[80px] w-full">
              <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="relative">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="text-sm text-gray-500">
                Purchases {marketingCycleData[marketingCycleData.length - 1]?.convert?.toLocaleString()} ↑ 12%
              </div>
            </div>
            <div className="h-[80px] w-full">
              <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="relative">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="text-sm text-gray-500">
                LTV {marketingCycleData[marketingCycleData.length - 1]?.retain?.toLocaleString()} ↑ 12%
              </div>
            </div>
            <div className="h-[80px] w-full">
              <ResponsiveContainer width="100%" height="100%">
